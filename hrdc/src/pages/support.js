      ...
      <div className="flex flex-col items-center w-full">
        ...
        <div className="w-full max-w-3xl p-6 text-center">
          ...
          <p className="text-gray-700 mt-4">
            Need a hand? Our dedicated tech support team is here to help you with any issues—whether it’s accessing your
            paychecks, navigating or accessing the HRDC portal, or anything else. No problem is too big or small; we’ll
            work quickly and help solve your issues.
          </p>
        ...
        <div className="w-full bg-green-900 text-white py-12 mt-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center max-w-5xl mx-auto">
            ...
            <div>
              ...
              <p><a href="mailto:HELLO.LIVINGSTON@THEHRDC.ORG" className="underline">HELLO.LIVINGSTON@THEHRDC.ORG</a>
              </p>
            </div>
            <div>
